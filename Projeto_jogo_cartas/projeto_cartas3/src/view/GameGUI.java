...
public class GameGUI implements ActionListener {
    ...
    public GameGUI() {
        ...
        button4 = criarBotao("Enviar", 10, 40, 50, 40, Color.WHITE, Color.GRAY);
        button5 = criarBotao("Enviar", 10, 100, 50, 40, Color.WHITE, Color.GRAY);
        ...
        // Campos de texto
        textField = criarCampoTexto(85, 40);
        textField2 = criarCampoTexto(85, 100);
        ...
        chatHistory.setFont(new Font("MV Boli", Font.PLAIN, 15));
    ...
    private JTextField criarCampoTexto(int x, int y) {
        ...
        campoTexto.setBounds(x, y, 200, 40);
        campoTexto.setFont(new Font("MV Boli", Font.PLAIN, 15));
        return campoTexto;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button1) {
            ...
            if (!message.isEmpty()) {
                chatHistory.append("Jogador 1: " + message + "\n");
                textField.setText("");
            }
        } else if (e.getSource() == button5) {
            String response = textField2.getText();
            if (!response.isEmpty()) {
                chatHistory.append("Jogador 2: " + response + "\n");
                textField2.setText("");
            }
        }
    }
